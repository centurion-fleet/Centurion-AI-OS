...
Built for [Centurion AI OS](https://github.com/centurion-fleet/Centurion-AI-OS). Usable in any coding agent. Canonical source lives here; synced to [`centurion-fleet/Centurion-AI-OS/skills/creative/ascii-video`](https://github.com/centurion-fleet/Centurion-AI-OS/tree/main/skills/creative/ascii-video) via PR.
