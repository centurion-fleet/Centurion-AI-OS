...
def _profile_user_agent() -> str:
    """Return a ``centurion-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from centurion_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"centurion-cli/{_ver}"
    except Exception:
        return "centurion-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # centurion-cli UA so the catalog endpoint is reachable.
