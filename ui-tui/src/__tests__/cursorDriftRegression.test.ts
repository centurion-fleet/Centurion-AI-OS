 ...
 *
 * Symptom: in `centurion --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@centurion/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using centurion --tui and as i type multiline my caret at the end will often ' +
