...
import type { ScrollBoxHandle } from '@centurion/ink'
import { evictInkCaches } from '@centurion/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.CENTURION_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
