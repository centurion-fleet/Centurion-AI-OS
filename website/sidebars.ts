...
const sidebars: SidebarsConfig = {
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-centurion-agent',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-debugging-centurion-tui-commands',
                    'user-guide/skills/bundled/software-development/software-development-centurion-agent-skill-authoring',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'guides/run-centurion-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-centurion',
        'guides/use-soul-with-centurion',
        'guides/use-voice-mode-with-centurion',
        'guides/build-a-centurion-plugin',
