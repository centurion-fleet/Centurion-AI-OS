...
```bash
python3 -m pyfiglet "CENTURION" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CENTURION&font=Slant" | boxes -d stone
```
