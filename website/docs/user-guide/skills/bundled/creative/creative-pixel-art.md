...
```python
import sys
sys.path.insert(0, "/home/teknium/.centurion/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.centurion/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Centurion installs package this)
