...
Control the user's Spotify account via the Centurion Spotify toolset (7 tools). Setup guide: https://github.com/centurion-fleet/Centurion-AI-OS/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `centurion auth spotify` again.
