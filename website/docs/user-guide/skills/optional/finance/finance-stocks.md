...
| | |
|---|---|
| Source | Optional — install with `centurion skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Centurion AI OS |
| License | MIT |
...
```
SCRIPT=~/.centurion/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.centurion/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
