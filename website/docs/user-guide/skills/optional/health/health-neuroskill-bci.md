...
| | |
|---|---|
| Source | Optional — install with `centurion skills install official/health/neuroskill-bci` |
...
Connect Centurion to a running [NeuroSkill](https://neuroskill.com/) instance to read
