...
| | |
|---|---|
| Source | Optional — install with `centurion skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Centurion AI OS |
| License | MIT |
...
Helper script path: `~/.centurion/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.centurion/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.centurion/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.centurion/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
