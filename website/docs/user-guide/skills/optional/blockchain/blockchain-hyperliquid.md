...
| | |
|---|---|
| Source | Optional — install with `centurion skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Centurion AI OS |
| License | MIT |
...
The script reads `~/.centurion/.env` for two optional defaults:
...
Helper script: `~/.centurion/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.centurion/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.centurion/.env`.
...
```bash
python3 ~/.centurion/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.centurion/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
