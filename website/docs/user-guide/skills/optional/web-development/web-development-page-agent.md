...
- User wants **Centurion itself to drive a browser** → use Centurion' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
