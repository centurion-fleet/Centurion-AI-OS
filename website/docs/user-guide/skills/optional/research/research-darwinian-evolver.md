...
| | |
|---|---|
| Source | Optional — install with `centurion skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Centurion AI OS |
| License | MIT |
...
import upstream classes into Centurion itself.
...
```bash
mkdir -p ~/.centurion/cache/darwinian-evolver && cd ~/.centurion/cache/darwinian-evolver
...
```bash
cd ~/.centurion/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.centurion/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.centurion/skills/research/darwinian-evolver
DE_DIR=~/.centurion/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Centurion core.
   Custom driver scripts under `~/.centurion/skills/...` are user-side and fine.
