...
| | |
|---|---|
| Source | Optional — install with `centurion skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Centurion AI OS (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $CENTURION_OSINT_CACHE/icij/ (default: ~/.cache/centurion-osint/icij/).
...
# Set CENTURION_OSINT_UA=your-app/1.0 (your@email) to identify yourself
