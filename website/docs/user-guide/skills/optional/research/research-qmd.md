...
| | |
|---|---|
| Source | Optional — install with `centurion skills install official/research/qmd` |
...
Centurion AI OS via the native MCP client. This is the preferred
...
Then configure Centurion AI OS to connect via HTTP:
