...
| | |
|---|---|
| Source | Optional — install with `centurion skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Centurion AI OS"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.centurion/.env`:
...
```bash
CANVAS="python $CENTURION_HOME/skills/productivity/canvas/scripts/canvas_api.py"
