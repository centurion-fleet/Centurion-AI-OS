...
| | |
|---|---|
| Source | Optional — install with `centurion skills install official/productivity/siyuan` |
...
```yaml
# In ~/.centurion/config.yaml under mcp_servers:
mcp_servers:
  siyuan:
    command: npx
