...
| | |
|---|---|
| Source | Optional — install with `centurion skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Centurion","productType":"Apparel","tags":["test"]}}'
```
