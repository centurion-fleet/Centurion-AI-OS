---
sidebar_position: 8
title: "Use Voice Mode with Centurion"
description: "A practical guide to setting up and using Centurion voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Centurion
...
- you want Centurion sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Centurion.
...
## Step 1: make sure normal Centurion works first
...
Centurion supports both local and cloud speech stacks.
...
4. Centurion transcribes and responds
...
- asking Centurion to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Centurion loop.

## Tuning CLI behavior

### Silence threshold

If Centurion starts/stops too aggressively, tune:
...
Centurion stays a normal chat bot, but can speak replies.
...
- you want Centurion to function like a portable research or ops assistant
...
Centurion joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Centurion detects speech boundaries
- transcripts are posted in the associated text channel
- Centurion responds in text and audio
