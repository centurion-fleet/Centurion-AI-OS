...
`./.centurion/plugins/` 下的项目本地插件默认禁用。仅对可信仓库启用，方法是在启动 Centurion 前设置 `HERMES_ENABLE_PROJECT_PLUGINS=true`。
...
| 项目 | `.centurion/plugins/` | 项目专属插件（需要 `HERMES_ENABLE_PROJECT_PLUGINS=true`） |
