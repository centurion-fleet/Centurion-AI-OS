...
在环境中设置 Tenor API 密钥（添加到 `~/.centurion/.env`）：
...
- GIF URL 可直接用于 markdown：`![alt](https://github.com/centurion-fleet/Centurion-AI-OS/blob/main/skills/media/gif-search/url)`