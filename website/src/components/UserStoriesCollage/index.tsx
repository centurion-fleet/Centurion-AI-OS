  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Centurion AI OS community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Centurion &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Centurion?{' '}
        <a
          href="https://github.com/centurion-fleet/Centurion-AI-OS/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
