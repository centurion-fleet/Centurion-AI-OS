...
- The wrapper exports bundled-skills path environment variables (`HERMES_BUNDLED_SKILLS`, `HERMES_OPTIONAL_SKILLS`, and `HERMES_MANAGED=homebrew`) so packaged installs keep runtime assets and defer upgrades to Homebrew. (Env var names are legacy identifiers in the runtime.)
