...
Data file: $CENTURION_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CENTURION_HOME = Path(os.environ.get("CENTURION_HOME", Path.home() / ".centurion"))
DATA_DIR = _CENTURION_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
