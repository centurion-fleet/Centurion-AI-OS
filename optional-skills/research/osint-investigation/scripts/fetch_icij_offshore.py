...
$HERMES_OSINT_CACHE/icij/ (default: ~/.cache/centurion-osint/icij/) and search
...
def main() -> int:
    ...
    p.add_argument(
        ...
        type=Path,
        default=None,
        help="Override cache directory (default: $HERMES_OSINT_CACHE/icij or ~/.cache/centurion-osint/icij)",
    )
    p.add_argument(
        "--force-refresh",
        action="store_true",
