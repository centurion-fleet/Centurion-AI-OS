...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Centurion\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "centurion@nousresearch.com",
    "centurion-audit@example.com",
    "centurion@habibilabs.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "centurion-fleet/Centurion-AI-OS",
                "--state", "merged",
