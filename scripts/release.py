#!/usr/bin/env python3
"""Centurion AI OS Release Script
...
VERSION_FILE = REPO_ROOT / "centurion_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "centurion@marian.local": "Schrotti77",
    ...
    "274096618+centurion-os-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "centurion@nousresearch.com": "NousResearch",
    ...
    "centurion@noushq.ai": "benbarclay",
    ...
    "centurion@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "agent@centurion.local": "jacdevos",
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (CENTURION_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (CENTURION_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: centurion-eval community link)
    ...
    "vigo@centurion": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.centurion@agentmail.to": "oseftg",
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "centurion@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/centurion-os",
    ...
    lines.append(f"# Centurion AI OS v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Centurion AI OS. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Centurion AI OS Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Centurion AI OS Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Centurion AI OS v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Centurion AI OS v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Centurion AI OS v{new_version} ({calver_date})' "
