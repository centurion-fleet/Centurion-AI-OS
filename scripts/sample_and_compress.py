...
DEFAULT_DATASETS = [
    ...
    "NousResearch/centurion-os-megascience-sft1",
    "NousResearch/Centurion-AI-OS-Thinking-GLM-4.7-SFT2",
    "NousResearch/Centurion-AI-OS-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-centurion-os"
]
