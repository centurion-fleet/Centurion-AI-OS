#!/usr/bin/env python3
"""Build the Centurion Model Catalog — a centralized JSON manifest of curated models.
...
Centurion CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Centurion release.
...
# Ensure CENTURION_HOME is set for imports that touch it at module level.
os.environ.setdefault("CENTURION_HOME", os.path.join(os.path.expanduser("~"), ".centurion"))

from centurion_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "centurion-os repo",
            "docs": "https://github.com/centurion-fleet/Centurion-AI-OS/tree/main/website/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
