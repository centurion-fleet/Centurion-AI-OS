#!/usr/bin/env python3
"""Build the Centurion Skills Index — a centralized JSON catalog of all skills.
...
`centurion skills search/install` can use it without hitting the GitHub API.
...
# Ensure CENTURION_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Centurion Skills Index...", flush=True)
