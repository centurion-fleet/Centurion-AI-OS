...
``_check_spotify_available()`` — when the user has not run ``centurion auth
spotify``, the tools remain registered (so they appear in ``centurion
...
The Spotify auth flow (``centurion auth spotify``), CLI plumbing, and docs
