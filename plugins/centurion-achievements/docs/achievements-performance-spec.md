# Centurion Achievements Performance Spec (Post-Hackathon)

Status: Draft (no code changes yet)
Owner: centurion-achievements plugin
...
### `GET /api/plugins/centurion-achievements/achievements`
...
### `POST /api/plugins/centurion-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/centurion-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/centurion-achievements/overview`
...
- Persist plugin data under:
  - `~/.centurion/plugins/centurion-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.centurion/plugins/centurion-achievements/scan_checkpoint.json`
...
- `~/.centurion/plugins/centurion-achievements/`
