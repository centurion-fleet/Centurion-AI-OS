# Centurion Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.centurion/plugins/centurion-achievements/state.json` (existing unlock state)
  - `~/.centurion/plugins/centurion-achievements/scan_snapshot.json` (new)
  - `~/.centurion/plugins/centurion-achievements/scan_checkpoint.json` (new)
