# Centurion Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.centurion/plugins/centurion-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.centurion/plugins/centurion-achievements/scan_checkpoint.json`.
