"""ntfy platform adapter (Centurion plugin).
...
a Centurion dependency.

This adapter ships as a Centurion platform plugin under
``plugins/platforms/ntfy/``. The Centurion plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "centurion-in"              # subscribe topic (incoming)
          publish_topic: "centurion-out"     # optional — defaults to topic
...
async def _standalone_send(
    ...
    *,
    ...
    ``centurion cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Centurion dependency",
