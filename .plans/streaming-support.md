# Streaming LLM Response Support for Centurion AI OS
...
```
CENTURION_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("CENTURION_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `centurion_cli/config.py` | 1 | +streaming config defaults |
...
CENTURION_STREAMING_ENABLED=true
```
