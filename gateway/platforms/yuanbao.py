...
try:
    ...
    _CENTURION_VERSION = "0.0.0"

_APP_VERSION = _CENTURION_VERSION
_BOT_VERSION = _CENTURION_VERSION
_YUANBAO_INSTANCE_ID = str(CENTURION_INSTANCE_ID)  # single source: yuanbao_proto.CENTURION_INSTANCE_ID
