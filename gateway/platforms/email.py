"""
Email platform adapter for the Centurion gateway.

Allows users to interact with Centurion by sending emails.
...
def _send_imap_id(imap: "imaplib.IMAP4") -> None:
    ...
    try:
        try:
            ...
            _centurion_version = "0"
        imap.xatom(
            "ID",
            f'("name" "centurion-os" "version" "{_centurion_version}" '
            '"vendor" "NousResearch" '
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Centurion AI OS")
        ...
        msg_id = f"<centurion-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
