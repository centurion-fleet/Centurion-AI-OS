...
import { ListItem } from "@centurion-fleet/ui/ui/components/list-item";
import { SelectionSwitcher } from "@centurion-fleet/ui/ui/components/selection-switcher";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="centurion-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="centurion-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({ onNavigate }: { onNavigate: () => void }) {
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateCenturion,
      runningLabel: t.status.updatingCenturion,
      spin: false,
    },
  ];
