...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateCenturion: "Werk Centurion AI OS op",
    updatingCenturion: "Besig om Centurion AI OS op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Centurion-inproppe op (`centurion plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.centurion/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.centurion/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.centurion/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Centurion AI OS-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Centurion AI OS-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Centurion AI OS meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Centurion AI OS 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Centurion AI OS skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
