...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateCenturion: "Centurion AI OS aktualisieren",
    updatingCenturion: "Centurion AI OS wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Centurion AI OS-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `centurion plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.centurion/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.centurion/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.centurion/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Centurion AI OS-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Centurion AI OS-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Centurion AI OS mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Centurion AI OS ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Centurion AI OS scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
