...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateCenturion: "Update Centurion",
    updatingCenturion: "Updating Centurion…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Centurion plugins (`centurion plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.centurion/plugins/?",
    removeHint: "Only user-installed plugins under ~/.centurion/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.centurion/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Centurion AI OS badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Centurion session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Centurion AI OS more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Centurion AI OS sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Centurion AI OS is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
