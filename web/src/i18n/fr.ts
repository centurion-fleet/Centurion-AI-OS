...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateCenturion: "Mettre à jour Centurion AI OS",
    updatingCenturion: "Mise à jour de Centurion AI OS…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Centurion AI OS (parité avec `centurion plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.centurion/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.centurion/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.centurion/skills/",
  ...
  config: {
    configPath: "~/.centurion/config.yaml",
    filters: "Filtres",
    sections: "Sections",
  ...
  achievements: {
    hero: {
      ...
      title: "Centurion Achievements",
      subtitle:
        "Badges Centurion AI OS à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Centurion AI OS en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Centurion AI OS davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Centurion AI OS détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Centurion AI OS analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Centurion AI OS 🦅",
    },
  },
  kanban: {
