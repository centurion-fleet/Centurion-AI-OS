...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateCenturion: "Centurion AI OS'i Güncelle",
    updatingCenturion: "Centurion AI OS güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Centurion AI OS eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`centurion plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.centurion/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.centurion/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.centurion/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Centurion AI OS rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "Centurion AI OS oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Centurion AI OS'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Centurion AI OS ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Centurion AI OS yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
