 ...
 *
 * Plugins call window.__CENTURION_PLUGINS__.register(name, Component)
...
import { Checkbox } from "@centurion-fleet/ui/ui/components/checkbox";
import { Select, SelectOption } from "@centurion-fleet/ui/ui/components/select";
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { Separator } from "@/components/ui/separator";
import { Tabs, TabsList, TabsTrigger } from "@centurion-fleet/ui/ui/components/tabs";
...
declare global {
  interface Window {
    __CENTURION_PLUGIN_SDK__: unknown;
    __CENTURION_PLUGINS__: {
...
export function exposePluginSDK() {
  window.__CENTURION_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__CENTURION_PLUGIN_SDK__ = {
