 ...
 * `window.__CENTURION_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Centurion brand in the top bar
 ...
 *  `window.__CENTURION_PLUGINS__.registerSlot(...)`.
 *
