...
const STORAGE_KEY = "centurion-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `centurion_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "centurion-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-centurion-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-centurion-theme-font", "true");
