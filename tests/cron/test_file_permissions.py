...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("centurion_cli.config.get_config_path", return_value=config_path), \
             patch("centurion_cli.config.ensure_centurion_home"):
    ...
    def test_ensure_centurion_home_sets_0700(self):
        home = Path(self.tmpdir) / ".centurion"
        with patch("centurion_cli.config.get_centurion_home", return_value=home):
