...
def test_estimate_tool_tokens_returns_positive_counts():
    ...
    from centurion_cli.tools_config import _estimate_tool_tokens, _tool_token_cache

    # Clear cache to force fresh computation
    import centurion_cli.tools_config as tc
...
def test_status_fn_returns_formatted_token_count(monkeypatch):
    ...
    import centurion_cli.tools_config as tc
    from centurion_cli.tools_config import CONFIGURABLE_TOOLSETS
...
def test_curses_checklist_numbered_fallback_shows_status(monkeypatch, capsys):
    ...
    from centurion_cli.curses_ui import _numbered_fallback
