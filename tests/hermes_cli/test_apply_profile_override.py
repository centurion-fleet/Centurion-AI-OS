...
When CENTURION_HOME is set to the hermes root (e.g. systemd hardcodes
CENTURION_HOME=/root/.hermes), _apply_profile_override must still read
...
class TestApplyProfileOverrideHermesHomeGuard:
    ...
    Verifies that CENTURION_HOME pointing to the hermes root does NOT suppress
    ...
    def test_hermes_home_at_root_with_active_profile_is_redirected(
        ...
        Bug scenario from #22502: systemd sets CENTURION_HOME to the hermes root
