...
def _clear_jwt_cache():
    ...
    import centurion_cli.copilot_auth as mod
...
class TestExchangeCopilotToken:
    ...
    def test_exchanges_token_successfully(self, mock_urlopen):
        from centurion_cli.copilot_auth import exchange_copilot_token
    ...
    def test_refreshes_expired_cache(self, mock_urlopen):
        from centurion_cli.copilot_auth import exchange_copilot_token, _jwt_cache, _token_fingerprint
...
class TestTokenFingerprint:
    ...
    def test_consistent(self):
        from centurion_cli.copilot_auth import _token_fingerprint
