...
Run from the PR worktree:
    ...
    cd ~/.centurion/centurion-os/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.centurion/centurion-os``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.centurion/centurion-os
PR_DIR = REPO_ROOT  # the worktree we're in
assert (MAIN_DIR / "tools" / "browser_tool.py").exists(), (
    f"MAIN_DIR={MAIN_DIR} doesn't look like a centurion-os checkout"
)
...
# Isolated CENTURION_HOME for the config write.
