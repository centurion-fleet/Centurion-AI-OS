...
def _isolate_env(tmp_path, monkeypatch):
    """Isolate CENTURION_HOME for each test.

    The global hermetic fixture already redirects CENTURION_HOME to a tempdir,
...
class TestBundledDiscovery:
    ...
    def test_disk_cleanup_discovered_but_not_loaded_by_default(self, _isolate_env):
        ...
        from centurion_cli import plugins as pmod
