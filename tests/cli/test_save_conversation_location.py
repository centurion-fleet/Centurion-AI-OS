...
def test_save_conversation_writes_under_centurion_home(centurion_home, tmp_path, monkeypatch, capsys):
    """Snapshot must land under ~/.centurion/sessions/saved/, not CWD."""
