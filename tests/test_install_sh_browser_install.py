...
Browser automation is optional. The installer should not leave Centurion
...
def test_install_script_skips_playwright_download_when_system_browser_exists() -> None:
    ...
    assert "Skipping Playwright browser download; Centurion will use the system browser." in text
