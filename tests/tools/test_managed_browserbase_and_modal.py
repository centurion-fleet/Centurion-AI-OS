...
def _enable_managed_nous_tools(monkeypatch):
    ...
    centurion_cli.auth and centurion_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("centurion_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("centurion_cli.models.check_nous_free_tier", lambda: False)
