...
class TestEnsureInstalled:
    ...
    def test_not_found_returns_none(self, mock_cfg):
        ...
        with patch("tools.tirith_security.shutil.which", return_value=None), \
             patch("tools.tirith_security._centurion_bin_dir", return_value="/nonexistent"), \
...
class TestDiskFailureMarker:
    ...
    def test_install_failed_recovers_from_centurion_bin(self):
...
class TestHermesHomeIsolation:
    ...
    def test_get_centurion_home_fallback(self):
        ...
        from tools.tirith_security import _get_centurion_home
