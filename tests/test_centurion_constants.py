"""Tests for centurion_constants module."""
...
class TestGetDefaultHermesRoot:
    ...
    def test_centurion_home_is_custom_path(self, tmp_path, monkeypatch):
        ...
        custom = tmp_path / "my-centurion-data"
        custom.mkdir()
        monkeypatch.setattr(Path, "home", lambda: tmp_path)
...
class TestIsContainer:
    ...
    def _reset_cache(self, monkeypatch):
        ...
        monkeypatch.setattr(centurion_constants, "_container_detected", None)
    ...
    def test_caches_result(self, monkeypatch):
        ...
        monkeypatch.setattr(centurion_constants, "_container_detected", True)
        assert is_container() is True
...
class TestSecureParentDir:
    ...
    def test_safe_path_calls_chmod(self, tmp_path, monkeypatch):
        ...
        safe_dir = tmp_path / "home" / "user" / ".centurion"
