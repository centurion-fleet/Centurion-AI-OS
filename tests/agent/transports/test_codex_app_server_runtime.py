...
class TestSpawnEnvIsolation:
    ...
    def test_kanban_worker_adds_only_kanban_writable_root(self, monkeypatch):
        ...
        danger-full-access. Centurion passes a narrow app-server config override
        ...
        assert (
            'sandbox_workspace_write.writable_roots=["/users/alice/.centurion/kanban/boards/smoke"]'
            in cmd
        )
