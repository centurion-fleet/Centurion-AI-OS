"""Tests for CodexEventProjector — codex item/* events → Centurion messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Centurion' message alternation invariant."""
