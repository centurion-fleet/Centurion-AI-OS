...
class TestServerRequestRouting:
    ...
    def test_mcp_elicitation_for_centurion_tools_auto_accepts(self):
        """When codex elicits on behalf of centurion-tools (our own callback),
