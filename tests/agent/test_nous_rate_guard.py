"""Tests for agent/nous_rate_guard.py — cross-session Centurion Portal rate limit guard."""
...
def rate_guard_env(tmp_path, monkeypatch):
    ...
    centurion_home = str(tmp_path / ".centurion")
    os.makedirs(centurion_home, exist_ok=True)
...
class TestIsGenuineNousRateLimit:
    ...
    Centurion Portal multiplexes upstreams (DeepSeek, Kimi, MiMo, Centurion).
