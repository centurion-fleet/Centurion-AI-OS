...
old_session_id=<old>). This lets plugin engines (e.g. centurion-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See centurion-lcm#68: after Centurion compresses and mints a new physical session,
