...
class TestSetupLogging:
    ...
    def test_creates_log_directory(self, centurion_home):
        log_dir = hermes_logging.setup_logging(centurion_home=centurion_home)
        assert log_dir == centurion_home / "logs"
        assert log_dir.is_dir()

    def test_creates_agent_log_handler(self, centurion_home):
        hermes_logging.setup_logging(centurion_home=centurion_home)
        root = logging.getLogger()
    ...
    def test_idempotent_no_duplicate_handlers(self, centurion_home):
        hermes_logging.setup_logging(centurion_home=centurion_home)
        hermes_logging.setup_logging(centurion_home=centurion_home)  # second call — should be no-op
    ...
    def test_force_reinitializes(self, centurion_home):
        ...
        hermes_logging.setup_logging(centurion_home=centurion_home, force=True)
    ...
    def test_custom_log_level(self, centurion_home):
        hermes_logging.setup_logging(centurion_home=centurion_home, log_level="DEBUG")
    ...
    def test_explicit_params_override_config(self, centurion_home):
        ...
        hermes_logging.setup_logging(centurion_home=centurion_home, log_level="WARNING")
...
class TestGatewayMode:
    ...
    def test_gateway_log_created(self, centurion_home):
        hermes_logging.setup_logging(centurion_home=centurion_home, mode="gateway")
        root = logging.getLogger()
    ...
    def test_gateway_log_not_created_in_cli_mode(self, centurion_home):
        hermes_logging.setup_logging(centurion_home=centurion_home, mode="cli")
        root = logging.getLogger()
