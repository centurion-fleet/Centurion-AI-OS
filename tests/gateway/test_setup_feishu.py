"""Tests for _setup_feishu() in centurion_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("centurion_cli.gateway.save_env_value", side_effect=mock_save), \
         patch("centurion_cli.gateway.get_env_value", side_effect=mock_get), \
         patch("centurion_cli.gateway.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("centurion_cli.gateway.prompt_choice", side_effect=prompt_choice_responses), \
         patch("centurion_cli.gateway.prompt", side_effect=prompt_responses), \
         patch("centurion_cli.gateway.print_info"), \
         patch("centurion_cli.gateway.print_success"), \
         patch("centurion_cli.gateway.print_warning"), \
         patch("centurion_cli.gateway.print_error"), \
         patch("centurion_cli.gateway.color", side_effect=lambda t, c: t), \
         patch("gateway.platforms.feishu.qr_register", return_value=qr_result):

        from centurion_cli.gateway import _setup_feishu
        _setup_feishu()
