...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "centurion_approve_once" in action_ids
        assert "centurion_approve_session" in action_ids
        assert "centurion_approve_always" in action_ids
        assert "centurion_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "centurion_deny", "value": "session-key"}
