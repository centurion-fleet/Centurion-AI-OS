"""
Tests for centurion_cli.mcp_config — ``centurion mcp`` subcommands.
...
class TestMcpList:
    def test_list_empty_config(self, tmp_path, capsys):
        from centurion_cli.mcp_config import cmd_mcp_list
...
class TestMcpRemove:
    def test_remove_existing_server(self, tmp_path, capsys, monkeypatch):
        ...
        from centurion_cli.mcp_config import cmd_mcp_remove
...
class TestMcpAdd:
    def test_add_no_transport(self, capsys):
        ...
        from centurion_cli.mcp_config import cmd_mcp_add
...
class TestConfigHelpers:
    def test_save_and_load_mcp_server(self, tmp_path):
        from centurion_cli.mcp_config import _save_mcp_server, _get_mcp_servers
    ...
    def test_remove_mcp_server(self, tmp_path):
        from centurion_cli.mcp_config import (
            _save_mcp_server,
            _remove_mcp_server,
            _get_mcp_servers,
        )
    ...
    def test_remove_nonexistent(self, tmp_path):
        from centurion_cli.mcp_config import _remove_mcp_server

        assert _remove_mcp_server("ghost") is False

    def test_env_key_for_server(self):
        from centurion_cli.mcp_config import _env_key_for_server
...
class TestMcpLogin:
    def test_login_rejects_unknown_server(self, tmp_path, capsys):
        _seed_config(tmp_path, {})
        from centurion_cli.mcp_config import cmd_mcp_login
