...
def kanban_home(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("CENTURION_MEDIA_ALLOW_DIRS", str(tmp_path))
    kb.init_db()
    return home
...
async def test_notifier_uploads_artifacts_on_completion(kanban_home, tmp_path, monkeypatch):
    ...
    # via ``CENTURION_MEDIA_ALLOW_DIRS``. Test fixtures live under ``tmp_path``,
    ...
    import os
    os.environ["CENTURION_KANBAN_TASK"] = tid
    try:
        ...
        os.environ.pop("CENTURION_KANBAN_TASK", None)
