"""Tests for Bug #12905 fix — stale OAuth token detection in centurion model flow.

Bug 3: `centurion model` with `provider=anthropic` skips OAuth re-authentication
...
from centurion_cli.config import load_env, save_env_value
