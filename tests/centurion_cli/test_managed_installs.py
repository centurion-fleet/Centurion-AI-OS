...
def test_format_managed_message_homebrew(monkeypatch):
    ...
    message = format_managed_message("update Centurion AI OS")
...
def test_recommended_update_command_defaults_to_centurion_update(monkeypatch):
    monkeypatch.delenv("CENTURION_MANAGED", raising=False)
...
def test_optional_skill_source_honors_env_override(monkeypatch, tmp_path):
    ...
    optional_dir.mkdir()
    monkeypatch.setenv("CENTURION_OPTIONAL_SKILLS", str(optional_dir))
