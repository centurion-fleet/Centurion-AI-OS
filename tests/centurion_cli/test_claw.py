"""Tests for centurion claw commands."""
...
from centurion_cli import claw as claw_mod
...
class TestFindMigrationScript:
    ...
    def test_finds_project_root_script(self, tmp_path):
        script = tmp_path / "openclaw_to_centurion.py"
...
class TestCmdMigrate:
    ...
    def test_dry_run_succeeds(self, tmp_path, capsys):
        ...
        fake_mod = ModuleType("openclaw_to_centurion")
    ...
    def test_full_preset_does_not_enable_secrets_silently(self, tmp_path, capsys):
        ...
        even under the 'full' preset.  This mirrors OpenClaw's migrate-centurion
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.centurion/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.centurion/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.centurion/migration/openclaw/20250312T120000",
        }
