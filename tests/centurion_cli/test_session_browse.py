"""Tests for the interactive session browser (`centurion sessions browse`).
...
from centurion_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """centurion sessions browse should be parseable."""
        from centurion_cli.main import main as _main_entry
