...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from centurion_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in CENTURION_OVERLAYS
        overlay = CENTURION_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify centurion doctor recognizes Xiaomi env vars."""
