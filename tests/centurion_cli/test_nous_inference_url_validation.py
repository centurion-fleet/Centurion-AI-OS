"""Regression tests for Centurion Portal inference_base_url host-allowlist validation.
...
class TestCallSiteWiring:
    ...
    def _read_auth_source(self):
        import centurion_cli.auth as _auth_mod
    ...
    def test_proxy_adapter_also_validates(self):
        ...
        boundary."""
        from pathlib import Path
        import centurion_cli.proxy.adapters.nous_portal as _nous_adapter
