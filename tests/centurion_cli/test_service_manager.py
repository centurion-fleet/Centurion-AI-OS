...
def test_s6_running_true_when_comm_and_basedir_match(
    ...
    from centurion_cli.service_manager import _s6_running
...
def test_s6_running_false_when_comm_unreadable(
    ...
    always-False inside the container under the centurion user. The new
...
# unprivileged centurion user from every lifecycle op. These tests run
...
def test_seed_supervise_skeleton_creates_expected_layout(tmp_path) -> None:
    ...
    from centurion_cli.service_manager import _seed_supervise_skeleton
...
def test_lifecycle_raises_gateway_not_registered_for_missing_slot(
    ...
    assert "'typo'" in msg
    assert "centurion profile create typo" in msg
...
def test_lifecycle_raises_s6_command_error_on_subprocess_failure(
    ...
    import subprocess as _sp
    from centurion_cli.service_manager import S6CommandError, S6ServiceManager
