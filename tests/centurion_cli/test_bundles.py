"""Tests for centurion_cli/bundles.py — the `centurion bundles` CLI subcommand."""
...
from centurion_cli.bundles import (
    bundles_command,
    register_cli,
)
...
def bundles_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("CENTURION_BUNDLES_DIR", str(bundles_dir))
