...
import pytest
from centurion_cli.config import DEFAULT_CONFIG, load_config, save_config
...
class TestNonInteractiveSetup:
    ...
    def test_cmd_setup_allows_noninteractive_flag_without_tty(self):
        ...
        from centurion_cli.main import cmd_setup
    ...
    def test_cmd_setup_defers_no_tty_handling_to_setup_wizard(self):
        """Bare `centurion setup` should reach setup.py, which prints headless guidance."""
        from centurion_cli.main import cmd_setup
    ...
    def test_non_interactive_flag_skips_wizard(self, capsys):
        ...
        with (
            ...
            patch("centurion_cli.setup.get_centurion_home", return_value="/tmp/.centurion"),
        ...
        assert "centurion config set model.provider custom" in out
    ...
    def test_main_accepts_tts_setup_section(self, monkeypatch):
        """`centurion setup tts` should parse and dispatch like other setup sections."""
