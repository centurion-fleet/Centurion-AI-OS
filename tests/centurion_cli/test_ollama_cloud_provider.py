...
from centurion_cli.auth import PROVIDER_REGISTRY, resolve_provider, resolve_api_key_provider_credentials
from centurion_cli.models import _PROVIDER_MODELS, _PROVIDER_LABELS, _PROVIDER_ALIASES, normalize_provider
...
class TestOllamaCloudMergedDiscovery:
    ...
    def test_stale_cache_used_on_total_failure(self, tmp_path, monkeypatch):
        ...
        from centurion_cli.models import fetch_ollama_cloud_models, _save_ollama_cloud_cache
...
class TestOllamaCloudProvidersNew:
    def test_overlay_exists(self):
        ...
        assert "ollama-cloud" in CENTURION_OVERLAYS
        overlay = CENTURION_OVERLAYS["ollama-cloud"]
        assert overlay.transport == "openai_chat"
        assert overlay.base_url_env_var == "OLLAMA_BASE_URL"

    def test_alias_resolves(self):
        from centurion_cli.providers import normalize_provider as np
        assert np("ollama") == "custom"  # bare "ollama" = local
        assert np("ollama-cloud") == "ollama-cloud"

    def test_label_override(self):
        from centurion_cli.providers import _LABEL_OVERRIDES
...
class TestOllamaCloudSuffixStripping:
    ...
    def test_strip_suffix_helper(self):
        ...
        from centurion_cli.models import _strip_ollama_cloud_suffix
