"""Tests that provider selection via `centurion model` always persists correctly.
...
class TestSaveModelChoiceAlwaysDict:
    def test_string_model_becomes_dict(self, config_home):
        ...
        from centurion_cli.auth import _save_model_choice
...
class TestProviderPersistsAfterModelSave:
    def test_update_config_for_provider_uses_atomic_yaml_write(self, config_home):
        ...
        from centurion_cli.auth import _update_config_for_provider
    ...
    def test_copilot_provider_saved_when_selected(self, config_home):
        ...
        from centurion_cli.main import _model_flow_copilot
        from centurion_cli.config import load_config
    ...
    def test_copilot_acp_provider_saved_when_selected(self, config_home):
        ...
        from centurion_cli.main import _model_flow_copilot_acp
        from centurion_cli.config import load_config
