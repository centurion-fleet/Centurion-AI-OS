"""Tests for `centurion curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated CENTURION_HOME with real agent-created skills on disk."""
    ...
    from centurion_cli import curator as curator_cli
