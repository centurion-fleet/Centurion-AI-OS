"""Windows UTF-8 bootstrap for Centurion entry points.
...
should be imported at the very top of every Centurion entry point
(``centurion``, ``centurion-os``, ``centurion-acp``, ``python -m gateway.run``,
...
# Apply on import — entry points just need ``import centurion_bootstrap``
# (or ``from centurion_bootstrap import apply_windows_utf8_bootstrap``) at
