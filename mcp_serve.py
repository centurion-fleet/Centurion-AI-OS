"""
Centurion MCP Server — expose messaging conversations as MCP tools.
...
Plus: channels_list (Centurion-specific extra)

Usage:
    centurion mcp serve
    centurion mcp serve --verbose
...
logger = logging.getLogger("centurion.mcp_serve")
...
class EventBridge:
    ...
    This is the Centurion equivalent of OpenClaw's WebSocket gateway bridge.
...
def create_mcp_server(event_bridge: Optional[EventBridge] = None) -> "FastMCP":
    """Create and return the Centurion MCP server with all tools registered."""
    ...
    mcp = FastMCP(
        "centurion",
        instructions=(
            "Centurion AI OS messaging bridge. Use these tools to interact with "
...
def run_mcp_server(verbose: bool = False) -> None:
    """Start the Centurion MCP server on stdio."""
    if not _MCP_SERVER_AVAILABLE:
        print(
