"""
Dump command for centurion CLI.

Outputs a compact, plain-text summary of the user's Centurion setup
...
def _redact(value: str) -> str:
    ...
    ``centurion dump`` formats empty values as blank, not as ``"(not set)"``).
    """
...
def _gateway_status() -> str:
    ...
    try:
        from centurion_cli.gateway import get_gateway_runtime_snapshot
...
def run_dump(args):
    ...
    toolsets = config.get("toolsets", ["centurion-cli"])
