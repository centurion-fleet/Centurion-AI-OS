...
def _has_centurion_os_browser() -> bool:
    ...
    # install.sh installs globally into $CENTURION_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-CenturionHome", str(get_centurion_home()),
        ]
    else:
