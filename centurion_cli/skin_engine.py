"""Centurion CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.centurion/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Centurion AI OS"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! 🦅"              # Shown on exit
      response_label: " 🦅 Centurion "       # Response box header label
...
.. code-block:: python
    ...
    from centurion_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Centurion AI OS"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.centurion/skins/
...
Drop a YAML file in ``~/.centurion/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces CENTURION_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces CENTURION_EAGLE)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Centurion — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Centurion AI OS",
            "welcome": "Welcome to Centurion AI OS! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " 🦅 Centurion ",
            "prompt_symbol": "❯",
...
def _skins_dir() -> Path:
    ...
    return get_centurion_home() / "skins"
