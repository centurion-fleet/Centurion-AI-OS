...
Usage:
    centurion pairing list              # Show all pending + approved users
    centurion pairing approve <platform> <code>  # Approve a pairing code
    centurion pairing revoke <platform> <user_id> # Revoke user access
    centurion pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle centurion pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: centurion pairing {list|approve|revoke|clear-pending}")
        print("Run 'centurion pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.centurion/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'centurion pairing list' to see pending codes.\n")
