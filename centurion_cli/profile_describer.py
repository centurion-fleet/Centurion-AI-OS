...
Used by ``centurion profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Centurion AI OS kanban board.
...
Rules:
  ...
  - Never write "Centurion AI OS profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_centurion_home())
        else:
