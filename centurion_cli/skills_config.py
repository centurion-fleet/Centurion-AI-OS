"""
Skills configuration for Centurion AI OS.
`centurion skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.centurion/config.yaml under:
...
from centurion_cli.config import cfg_get, load_config, save_config
from centurion_cli.colors import Colors, color
from centurion_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `centurion skills`."""
    from centurion_cli.curses_ui import curses_checklist
