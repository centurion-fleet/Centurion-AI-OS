...
DEFAULT_CONFIG = {
    ...
    "terminal": {
        ...
        # bundled Hermes image, which drops to the `centurion` user via
    ...
    "updates": {
        # Run a full ``hermes backup``-style zip of CENTURION_HOME before every
...
def load_env() -> Dict[str, str]:
    ...
    interactive menu render (`centurion tools`, `hermes setup`, status
