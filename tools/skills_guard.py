...
Trust levels:
  - builtin:   Ships with Centurion. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\.centurion/config\.yaml|\.centurion/SOUL\.md',
     "centurion_config_mod", "critical", "persistence",
     "references Centurion configuration files directly"),
