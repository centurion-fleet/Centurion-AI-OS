...
DANGEROUS_PATTERNS = [
    ...
    (r'\bhermes\s+gateway\s+(stop|restart)\b', "stop/restart centurion gateway (kills running agents)"),
    (r'\bhermes\s+update\b', "centurion update (restarts gateway, kills running agents)"),
