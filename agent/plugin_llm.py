...
Plugins built on Centurion AI OS often need to make their own LLM calls
...
Today the only stable plugin surfaces extend an existing Centurion
...
embedded slugs, no shorthands. This mirrors Centurion' main config
...
handles every provider, fallback chain, and per-task override Centurion
supports.
"""
