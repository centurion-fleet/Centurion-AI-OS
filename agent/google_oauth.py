...
Storage (``~/.centurion/auth/google_oauth.json``, chmod 0o600):
...
from centurion_constants import get_centurion_home, secure_parent_dir
...
#
# Resolution order:
#   1. CENTURION_GEMINI_CLIENT_ID / CENTURION_GEMINI_CLIENT_SECRET env vars (power users)
...
ENV_CLIENT_ID = "CENTURION_GEMINI_CLIENT_ID"
ENV_CLIENT_SECRET = "CENTURION_GEMINI_CLIENT_SECRET"
...
_HEADLESS_ENV_VARS = ("SSH_CONNECTION", "SSH_CLIENT", "SSH_TTY", "CENTURION_HEADLESS")
...
def _credentials_path() -> Path:
    return get_centurion_home() / "auth" / "google_oauth.json"
...
def _require_client_id() -> str:
    ...
    if not cid:
        raise GoogleOAuthError(
            ...
            "  2. Set CENTURION_GEMINI_CLIENT_ID and CENTURION_GEMINI_CLIENT_SECRET in ~/.centurion/.env\n"
            "\n"
