#!/usr/bin/env python3
"""
SWE Runner with Centurion Trajectory Format

A runner that uses Centurion-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Centurion-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Centurion-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Centurion format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Centurion-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Centurion-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Centurion Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Centurion-Agent's built-in execution environments
    and outputs trajectories in Centurion-Agent format.
    """
    ...
    def _convert_to_centurion_format(
        ...
        """
        Convert internal message format to Centurion trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Centurion trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Centurion trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Centurion Trajectory Format")
    print("=" * 60)
